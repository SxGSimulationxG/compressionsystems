\subsection{Shannon Kodierung}
Auch wenn die von Claude E. Shannon vorgeschlagene Shannon-Methode aufgrund ihrer Ineffizienz hinsichtlich der resultierenden Kompressionsgröße nicht häufig verwendet wird, hat sie dennoch eine gewisse Relevanz in dem Bereich der Informationstheorie.
...
\begin{equation}
	...
	\begin{array}{lll}
		0 & \textbf{für} & i = 1 \\
		P_{i-1} + p_{i-1} & \textbf{für} & 2 \leq i \leq m
	\end{array}
	\right.
\end{equation}
...
\subsubsection{Beispiel: Statische Shannon Kodierung}
